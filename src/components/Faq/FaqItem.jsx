...
setIsOpen(!isOpen);
  ...
  return (
    ...
    {item.question}
        ...
        <div
        className= {`${isOpen && 'bg-primaryColor text-white border-none'} w-7 h-7 lg:w-8 last:h-8 border border-solid border-[#141F21] rounded flex items-center justify-center `} >

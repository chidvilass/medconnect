...
const FeedbackForm = () => {
   ...
   const handleSubmitReview = async (e)=>{
    ...
    try {
        ...
        {
            const res = await fetch(`/api/v1/doctor/${id}/reviews`,{
                method:'post',
                headers:{
  ...
  return (
    <form >
        ...
        <div className=' mt-[30px]'>
            ...
            <textarea 
            className=' border border-solid border-[#0066ff34] focus:outline outline-primaryColor w-full px-6 py-3 rounded-md '
            rows='5'
        ...
        <button className=' btn' onClick={handleSubmitReview} type='submit'>
            {loading? <HashLoader size={25} color='' /> :'Submit Feedback'}
        </button>
